seed =  -1
       ...
       seqfile = cercis_phylip.phy
      Imapfile = Imap3varieties.txt
       outfile = 3varietiesA11out.txt
      mcmcfile = 3varietiesA11mcmc.txt
...
*  uniformrootedtrees = 1         * 0 means uniform labeled histories
  ...
  species&tree = 5 s c t m o
                   2    2    2    2    2	*it says in the help files that it's okay to put 2 even if there are more than 2
                   (s,((c,(t,m)),o));    *it has to be binary

	phase = 0 0 0 0 0 *these are phased haplotype sequences
